...
if [[ -n $GPU_MACHINE_CORES ]] && [[ -n $GPU_MACHINE_NAME ]]; then
    ...
    gcloud ai custom-jobs create \
      ...
      --labels=application_name=iris_classification,git_project=classification-model-test,model_name=$MODEL_NAME,git_branch=$GIT_BRANCH,version=$VERSION,component=preprocessing \
